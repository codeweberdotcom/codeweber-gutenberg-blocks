...
const FeaturesEdit = ({ attributes, setAttributes, clientId }) => {
	...
	const applyTemplate = (template) => {
		...
		const { columnsConfig, featuresConfig, featureData, columnConfig, firstColumn } = template;
		...
		if (firstColumn !== null && firstColumn !== undefined) {
			...
			const cardBlock = createBlock('codeweber-blocks/card', {
				enableCard: true,
				enableCardBody: true,
				...
				createBlock('codeweber-gutenberg-blocks/heading-subtitle', {
					enableTitle: true,
					enableSubtitle: true,
					enableText: firstColumn.enableText !== undefined ? firstColumn.enableText : true,
					subtitle: firstColumn.subtitle || '',
					title: firstColumn.title || '',
					text: firstColumn.text || '',
					subtitleLine: firstColumn.subtitleLine !== undefined ? firstColumn.subtitleLine : false,
					align: 'left',
			...
			columnBlocks.push(createBlock('codeweber-blocks/column', firstColumnAttrs, [cardBlock]));
		}
		...
		const featureColumns = featureData.map((data, index) => {
			...
			const featureAttrs = {
				...
				iconColor: data.iconColor !== undefined && data.iconColor !== null && data.iconColor !== '' 
					? data.iconColor 
					: (featuresConfig.iconColor !== undefined && featuresConfig.iconColor !== null && featuresConfig.iconColor !== '' 
						? featuresConfig.iconColor 
						: 'white'),
				iconColor2: data.iconColor2 !== undefined && data.iconColor2 !== null && data.iconColor2 !== '' 
					? data.iconColor2 
					: (featuresConfig.iconColor2 !== undefined && featuresConfig.iconColor2 !== null && featuresConfig.iconColor2 !== '' 
						? featuresConfig.iconColor2 
						: '11'),
				iconBtnVariant: data.iconBtnVariant !== undefined && data.iconBtnVariant !== null && data.iconBtnVariant !== '' 
					? data.iconBtnVariant 
					: (featuresConfig.iconBtnVariant !== undefined && featuresConfig.iconBtnVariant !== null && featuresConfig.iconBtnVariant !== '' 
						? featuresConfig.iconBtnVariant 
						: 'gradient'),
				buttonColor: data.buttonColor !== undefined && data.buttonColor !== null && data.buttonColor !== '' 
					? data.buttonColor 
					: (featuresConfig.buttonColor !== undefined && featuresConfig.buttonColor !== null && featuresConfig.buttonColor !== '' 
			...
			const columnAttrs = columnConfig && columnConfig[featureIndex] 
		...
		const columnsBlock = createBlock('codeweber-blocks/columns', columnsConfig, columnBlocks);
	...
	useEffect(() => {
		...
		const defaultTemplate = featuresTemplates.find(t => t.id === 'default');
		if (defaultTemplate) {
	...
	useEffect(() => {
		...
		const template = featuresTemplates.find(t => t.id === selectedTemplate);
	...
	}, [selectedTemplate, innerBlocks, featuresTemplates, updateBlockAttributes]);
				...
				<TabPanel tabs={tabs}>
					{(tab) => (
						<>
							{/* FEATURE TAB */}
							{tab.name === 'feature' && (
								<PanelBody title={__('Feature Settings', 'codeweber-gutenberg-blocks')} initialOpen={true}>
									<SelectControl
										label={__('Template', 'codeweber-gutenberg-blocks')}
										value={selectedTemplate || 'default'}
										options={featuresTemplates && Array.isArray(featuresTemplates) ? featuresTemplates.map(t => ({
											value: t.id,
											label: t.labelKey ? __(t.labelKey, 'codeweber-gutenberg-blocks') : t.label,
										})) : [{ value: 'default', label: __('Default Template', 'codeweber-gutenberg-blocks') }]}
