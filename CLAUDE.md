...
| Post Grid: tabs, attributes, per-CPT behavior, filter bar, REST, gotchas | `doc_claude/blocks/POST_GRID.md` |
| Floating Navigator: attributes, HTML, JS scroll/active, rotation CSS, gotchas | `doc_claude/blocks/FLOATING_NAVIGATOR.md` |
