...
export const HeadingTypographyControl = ({
	attributes,
	setAttributes,
	hideSubtitle = false,
	hideText = false,
			...
			{activeTab === 'subtitle' && (
				<>
					<TagControl
						...
						value={subtitleTag}
						onChange={(value) =>
							setAttributes({ subtitleTag: value })
						}
						type="subtitle"
					/>
					<ColorTypeControl
						...
						onChange={(value) =>
							setAttributes({ subtitleColorType: value })
						}
						options={[
							{
								value: 'solid',
					...
					<SelectControl
						...
						options={createWeightOptions()}
						onChange={(value) =>
							setAttributes({ subtitleWeight: value })
						}
					/>
					<SelectControl
						label={__(
						...
						options={createTransformOptions()}
						onChange={(value) =>
							setAttributes({ subtitleTransform: value })
						}
					/>
					<SelectControl
					...
					<TextControl
						...
						value={subtitleClass}
						onChange={(value) =>
							setAttributes({ subtitleClass: value })
						}
						placeholder="mb-4 custom-class"
						help={__(
							'Additional CSS classes',
			...
			{!hideText && activeTab === 'paragraph' && (
				<>
					...
					<ColorTypeControl
						...
						value={textColorType}
						onChange={(value) =>
							setAttributes({ textColorType: value })
						}
						options={[
							{
								value: 'solid',
