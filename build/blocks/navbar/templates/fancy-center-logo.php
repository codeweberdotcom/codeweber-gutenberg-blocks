 ...
 * @var string $logo_variant  Logo variant for get_custom_logo_type (dark navbar = light logo).
				...
				<div class="navbar-collapse-inner d-flex flex-row align-items-center w-100 mt-0">
					<div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start <?php echo esc_attr($offcanvas_class); ?>">
						<div class="offcanvas-header d-lg-none">
							...
							<button type="button" class="btn-close<?php echo (strpos($offcanvas_class ?? '', 'dark') !== false) ? ' btn-close-white' : ''; ?>" data-bs-dismiss="offcanvas" aria-label="Close"></button>
						</div>
