					...
					if (n.options.instantUpload) {
						...
						return null == a
							...
							: 'boolean' == typeof a
								? o(a)
								: void (
										'function' == typeof a.then && a.then(o)
									);
					}
	...
	var Kt,
				...
				if (0 !== u.length) {
					...
					if (1 === m) {
						...
						u.forEach(function (e, t) {
							...
							(o &&
								((e.translateX = null), (e.translateY = null)),
		...
		Bn = function (e) {
			...
			if (t.query('GET_TOTAL_ITEMS') > 0) {
				...
				for (
					var r = t.query('GET_ACTIVE_ITEMS'), o = !1, i = 0;
					i < r.length;
					i++
				)
					r[i].status === Ie.LOAD_ERROR && (o = !0);
				t.element.setCustomValidity(
					o ? t.query('GET_LABEL_INVALID_FIELD') : ''
				);
			} else {
