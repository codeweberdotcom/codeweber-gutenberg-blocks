					...
					{tab.name === 'text' &&
						!(
							...
							<PanelBody>
								...
								>
									{__(
										'Text settings are available only for Text divider style.',
										'codeweber-gutenberg-blocks'
									)}
								</p>
							</PanelBody>
					...
					{tab.name === 'background' &&
						!(
							...
							<PanelBody>
								...
								>
									{__(
										'Background settings are available only for Text divider style.',
										'codeweber-gutenberg-blocks'
									)}
								</p>
							</PanelBody>
