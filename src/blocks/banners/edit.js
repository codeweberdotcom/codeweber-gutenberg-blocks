...
const BannersEdit = ({ attributes, setAttributes, clientId }) => {
		...
		if (bannerType === 'banner-6') {
			return [
				...
				['codeweber-blocks/button', {
					...
					ButtonClass: 'btn-primary btn-icon btn-icon-start rounded me-2',
				}],
				['codeweber-blocks/button', {
					ButtonContent: 'Google Play',
					ButtonClass: 'btn-green btn-icon btn-icon-start rounded',
				}],
			];
		}
		...
		if (bannerType === 'banner-7') {
			return [
				['codeweber-gutenberg-blocks/heading-subtitle', {
					...
					textClass: 'lead fs-24 lh-sm px-md-5 px-xl-15 px-xxl-10 mb-7',
				}],
				['codeweber-blocks/button', {
				...
				['codeweber-blocks/button', {
					ButtonContent: 'Contact Us',
					ButtonClass: 'btn-lg btn-outline-primary rounded-pill mx-1',
				}],
			];
		}
		...
		if (bannerType === 'banner-27') {
			return [
				['codeweber-gutenberg-blocks/heading-subtitle', {
					...
					text: 'We are a creative company that focuses on long term relationships with customers.',
					titleSize: 'display-1 fs-56 mb-4 mt-0 mt-lg-5 ls-xs pe-xl-5 pe-xxl-0',
					textClass: 'lead fs-23 lh-sm mb-7 pe-lg-5 pe-xl-5 pe-xxl-0',
				}],
				['codeweber-blocks/button', {
					ButtonContent: 'Read More',
	...
	const renderBanner = () => {
		switch (bannerType) {
			...
			case 'banner-1':
				return <Banner1 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-2':
				return <Banner2 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-4':
				return <Banner4 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-6':
				return <Banner6 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-7':
				return <Banner7 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-8':
				return <Banner8 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-10':
				return <Banner10 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-11':
				return <Banner11 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-15':
				return <Banner15 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-16':
			...
			case 'banner-24':
				return <Banner24 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-25':
				return <Banner25 attributes={attributes} isEditor={true} clientId={clientId} />;
			case 'banner-27':
