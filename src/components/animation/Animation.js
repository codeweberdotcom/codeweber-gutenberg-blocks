...
const animationOptions = [
    ...
    { value: 'slideInLeft', label: __('Slide In Left', 'codeweber-gutenberg-blocks') },
    { value: 'slideInRight', label: __('Slide In Right', 'codeweber-gutenberg-blocks') },
    { value: 'slideInDown', label: __('Slide In Down', 'codeweber-gutenberg-blocks') },
    { value: 'slideInUp', label: __('Slide In Up', 'codeweber-gutenberg-blocks') },
    ...
    { value: 'bounceInLeft', label: __('Bounce In Left', 'codeweber-gutenberg-blocks') },
    { value: 'bounceInRight', label: __('Bounce In Right', 'codeweber-gutenberg-blocks') },
    { value: 'bounceInDown', label: __('Bounce In Down', 'codeweber-gutenberg-blocks') },
    { value: 'bounceInUp', label: __('Bounce In Up', 'codeweber-gutenberg-blocks') },
    ...
    return (
        <div>
            <ToggleControl
                ...
                help={animationEnabled ? __('Scroll in editor to preview animation', 'codeweber-gutenberg-blocks') : ''}
            />
            {animationEnabled && (
                <>
                    <SelectControl
                        label={__('Animation Type', 'codeweber-gutenberg-blocks')}
                        value={animationType}
                        options={animationOptions}
                        onChange={(value) => setAttributes({ animationType: value })}
                    />
                    <RangeControl
                        label={__('Duration (ms)', 'codeweber-gutenberg-blocks')}
